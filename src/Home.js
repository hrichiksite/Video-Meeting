...
class Home extends Component {
	...
	render() {
		return (	
			...
			<div className="container2">
				<div style={{fontSize: "14px", background: "white", width: "10%", textAlign: "center", margin: "auto", marginBottom: "10px"}}>					<div style={{fontSize: "14px", background: "white", width: "10%", textAlign: "center", margin: "auto", marginBottom: "10px"}}>
					Source code: 						Source code: 
					<IconButton style={{color: "black"}} onClick={() => window.location.href="https://github.com/0x5eba/Video-Meeting"}>						<IconButton style={{color: "black"}} onClick={() => window.location.href="https://github.com/0x5eba/Video-Meeting"}>
				...
				<div>
					<h1 style={{ fontSize: "45px" }}>MeetUp Now</h1>
				...
				<div style={{
					...
					<img src="https://i.imgur.com/mrITChb.png" alt="Meeting" width="200" height="150">
